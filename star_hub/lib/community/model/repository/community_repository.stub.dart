...
//     return fullPostList.cast<ScopeFullPostEntity>().where((post) => post.categoryId == 1).toList(); // scope
//   }
//
//   @override
//   Future<List<PlaceFullPostEntity>> getFullPlacePost(int offset) async {
//     return fullPostList.cast<PlaceFullPostEntity>().where((post) => post.categoryId == 2).toList(); // place
//   }
//
//   @override
//   Future<List<PhotoFullPostEntity>> getFullPhotoPost(int offset) async {
//     return fullPostList.cast<PhotoFullPostEntity>().where((post) => post.categoryId == 3).toList(); // photo
//   }
//
//   @override
...
//         content: detailPost.contentText,
...
//           (post) => post.id == entity.articleId,
//     );
//     postToUpdate.contentText = entity.content;
//   }
//
//   @override
