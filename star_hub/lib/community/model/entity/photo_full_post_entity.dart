...
part 'photo_full_post_entity.g.dart';
...
class PhotoFullPostEntity {
  ...
  Map<String, dynamic> toJson() => _$PhotoFullPostEntityToJson(this);

  factory PhotoFullPostEntity.fromJson(Map<String, dynamic> json) =>
      _$PhotoFullPostEntityFromJson(json);

  PhotoFullPostEntity copyWith({
    int? clips,
    int? comments,
    String? contentText,
    int? likes,
