...
class ScopePostEntity {
  ...
  Map<String, dynamic> toJson() => _$ScopePostEntityToJson(this);

  factory ScopePostEntity.fromJson(Map<String, dynamic> json) =>
      _$ScopePostEntityFromJson(json);
}
