...
class DetailPage extends ConsumerStatefulWidget {
  const DetailPage(this.type, this.postId, this.writerId, {Key? key})
      : super(key: key);
  final int? type;
  final int writerId;
  final int postId;
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () => newComment.isNotEmpty
                              ? _submitComment(
                                  widget.type, state.value!, viewModel, context)
                              : null,
